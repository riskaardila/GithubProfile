...
import com.example.githubprofile.services.GithubUsersService
...
class MainViewModel : ViewModel(){
    ...
    fun searchUser(query: String){
        ...
        val githubUserService: GithubUsersService = ServiceBuilder.buildService(GithubUsersService::class.java)
